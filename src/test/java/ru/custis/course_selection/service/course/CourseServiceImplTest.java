...
class CourseServiceImplTest {
    ...
    void getAllCourse_Successful() {
        Course firstCurse = new Course(0L, "titleOne", 0,
                null, null, new ArrayList<>());
        Course secondCurse = new Course(1L, "titleTwo", 0,
                null, null, new ArrayList<>());

        CourseDto firstCourseDto = new CourseDto("title", 0L, 0L, null,
                null, new ArrayList<>());
        CourseDto secondCourseDto = new CourseDto("titleTwo", 0L, 0L,
                null, null, new ArrayList<>());
    ...
    void updateCourse_whenSuccessful_ThenReturnCourse() {
        CourseInitDto courseInitDto = new CourseInitDto("title New", 20L,
                null, null);
        Course courseNew = new Course(0L, "title New", 20L, null,
                null, new ArrayList<>());
        Course course = new Course(0L, "title", 10L,
                null, null, new ArrayList<>());
        CourseDto courseDtoNew = new CourseDto("title New", 0L,
                20L, null, null, new ArrayList<>());
